...
namespace Wallet.Storage.Migrations
{
    ...
    [Migration("20230405195324_FixRalationCardBalanceToUser")]
    partial class FixRalationCardBalanceToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wallet.Domain.Entities.CardBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Wallet.Domain.Entities.CardBalance", b =>
                {
                    b.HasOne("Wallet.Domain.Entities.User", "User")
                        .WithOne("CardBalance")
                        .HasForeignKey("Wallet.Domain.Entities.CardBalance", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
